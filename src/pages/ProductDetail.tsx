...
const ProductDetail = () => {
  ...
  const steps = [
    { number: 1, title: "Size & Quantity", description: "Choose your perfect size" },
    { number: 2, title: "Upload Artwork", description: "Add your design" },
    { number: 3, title: "Review & Order", description: "Confirm your order" }
  ];
              ...
              <div className="bg-white rounded-2xl p-8 shadow-xl">
                <div className="mb-6">
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-sm text-gray-500">(4.9/5 from 127 reviews)</span>
                  </div>
                  {product.description && (
                    ...
                    {currentStep === 1 && (
                      <div className="space-y-8">
                        ...
                        <Button
                          ...
                          className="w-full bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white py-4 text-lg font-semibold rounded-xl shadow-lg transition-all duration-300 transform hover:scale-[1.02]"
                        >
                          Continue to Artwork
                    ...
                    {currentStep === 2 && (
                      <div className="space-y-6">
                        ...
                        <Button
                          ...
                          className="w-full py-3 text-lg border-2 border-gray-300 hover:border-gray-400 transition-colors"
                        >
                      ...
                      <div className="space-y-8">
                        ...
                        <div className="flex gap-4">
                          <Button
                            variant="outline"
                            onClick={() => setCurrentStep(2)}
                            className="flex-1 py-3 text-lg border-2 border-gray-300 hover:border-gray-400"
                          >
                            <ArrowLeft className="w-5 h-5 mr-2" />
                            Back
                          </Button>
                          <Button
                            ...
                            className="flex-1 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white py-3 text-lg font-semibold rounded-xl shadow-lg transition-all duration-300 transform hover:scale-[1.02]"
                          >
                            Complete Order
                            <ArrowRight className="w-5 h-5 ml-2" />
                          </Button>
