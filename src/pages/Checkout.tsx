          ...
          <Card className="shadow-lg">
            ...
            <CardContent className="p-8 space-y-6">
              <div>
                ...
                <Input id="name" value={customerName} onChange={e => setCustomerName(e.target.value)} placeholder="Enter your full name" className="mt-2 h-12" />
              </div>
              <div>
                <Label htmlFor="email" className="text-base font-medium">Email Address *</Label>
                <Input id="email" type="email" value={customerEmail} onChange={e => setCustomerEmail(e.target.value)} placeholder="Enter your email address" className="mt-2 h-12" />
          ...
          <Card className="shadow-lg">
            ...
            <CardContent className="p-8 space-y-6">
              <div className="space-y-4">
                ...
                {orderData.customWidth && orderData.customHeight && <div className="flex justify-between py-2">
                    <span className="font-medium">Custom Size:</span>
                    <span>{orderData.customWidth}" × {orderData.customHeight}"</span>
                  </div>}
                {artworkName && <div className="py-2">
                    <div className="flex justify-between items-start mb-2">
                      <span className="font-medium">Artwork:</span>
                      <span className="text-sm text-right max-w-48 truncate">{artworkName}</span>
                    </div>
                    {artworkPreview && <div className="mt-2">
                        <img src={artworkPreview} alt="Artwork preview" className="w-full h-32 object-contain bg-gray-50 rounded-lg border" />
                      </div>}
                  </div>}
              </div>
              ...
              <Button className="w-full bg-orange-600 hover:bg-orange-700 h-14 text-lg font-semibold" onClick={handleSubmitOrder} disabled={isLoading}>
