          ...
          <div className="w-full md:w-1/2 flex justify-center md:justify-end animate-slide-up">
            <div className="relative w-full max-w-lg">
              ...
              <div className="relative bg-white rounded-3xl shadow-xl overflow-hidden">
                <img src="/hero.png" alt="Colorful sticker collection" className="w-full h-auto" />
              </div>
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg p-4 w-40">
                ...
                <div className="flex">
                  {[...Array(5)].map((_, i) => <svg key={i} className="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
