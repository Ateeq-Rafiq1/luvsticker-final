        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div>
            ...
            {/* <div className="flex gap-4 mt-4">
              <a href="#" className="text-gray-500 hover:text-istickers-orange transition-colors">
          ...
          <div>
            ...
            {/* <div className="mt-8">
              <h4 className="text-sm font-semibold uppercase tracking-wider text-gray-500 mb-3">Subscribe to our newsletter</h4>
              <div className="flex gap-2">
                <input
                  type="email"
                  placeholder="Enter your email"
                  className="px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-istickers-orange focus:border-transparent flex-1"
                />
                <button className="bg-istickers-orange hover:bg-istickers-orange/90 text-white px-4 py-2 rounded text-sm font-medium">
                  Subscribe
                </button>
              </div>
            </div> */}
        ...
        <div className="border-t border-gray-300 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-center items-center">
            <p className="text-gray-500 text-sm">
              ...
              {/* <a
                href="https://www.argonteq.com"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-istickers-orange"
              >
                www.argonteq.com
              </a> */}
               All rights reserved.
            ...
            {/* <div className="flex gap-6 mt-4 md:mt-0">
              <Link to="#" className="text-sm text-gray-500 hover:text-istickers-orange">Privacy Policy</Link>
              <Link to="#" className="text-sm text-gray-500 hover:text-istickers-orange">Terms of Service</Link>
            </div> */}
          </div>
        </div>
